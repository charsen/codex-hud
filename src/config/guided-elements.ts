...
export const GUIDED_ELEMENTS: readonly GuidedElementDefinition[] = [
  ...
  { name: 'images', category: 'Session', label: 'Session image gallery', get: config => config.display.showImages, set: (config, value) => config.display.showImages = value },
  ...
  { name: 'lastCompleted', category: 'Session', label: 'Task activity / completion time', get: config => config.display.showLastCompletedAt, set: (config, value) => config.display.showLastCompletedAt = value },
